...
class DolbyPreferenceStore(private val context: Context) : PreferenceDataStore() {
  ...
  private val defaultSharedPrefs by lazy { PreferenceManager.getDefaultSharedPreferences(context) }
  ...
  var profile = 0
    set(value) {
      field = value
      profileSharedPrefs = context.getSharedPreferences("profile_$value", Context.MODE_PRIVATE)
    }
  ...
  override fun getInt(key: String, defValue: Int) = getSharedPreferences(key).getInt(key, defValue)
